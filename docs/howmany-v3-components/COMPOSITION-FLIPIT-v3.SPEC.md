...
| HUD **FLiPIT** (`#btn-gcode`) | Closed → open as the **flip-angle strip**. The resting panel has only 0°, 90°, −90°, and 180° choices; no code is on stage. Choosing an angle earns the editor. X closes from any state. |
