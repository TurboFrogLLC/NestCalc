...
| **Composition host** | `COMPOSITION-FLIPIT-v3.html` | `COMPOSITION-FLIPIT-v3.SPEC.md` | `f8773d7f…` |
...
3. Load `COMPOSITION-FLIPIT-v3.html` for the assembled host + bridges (R17 / R27 / R29 / R30 / R1–R10 chrome)
