...
3. Load `COMPOSITION-FLIPIT-v3.html` for the assembled host + bridges (R17 / R27 / R29 / R30 / R1–R13 chrome)
4. Load `COMPOSITION-FLIPIT-radar.html` for the parallel radar-skin host (behavior from V3, color from `authority/audience-radar-skin.png`). Do not edit V3 from that host.
5. HTML wins on pixel/token conflicts vs SPEC
