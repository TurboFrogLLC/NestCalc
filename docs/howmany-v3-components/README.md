...
| **Composition host** | `COMPOSITION-FLIPIT-v3.html` | `COMPOSITION-FLIPIT-v3.SPEC.md` | `4809d348…` |
...
3. Load `COMPOSITION-FLIPIT-v3.html` for the assembled host + bridges (R17 / R27 / R29 / R30 / R1–R12 chrome)
