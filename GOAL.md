...
```json
{
  ...
  "agent_roster": {
    ...
    "read_only_agents": [
      {
        "lane": "keyboard, AutoNest, G-code Fill, and margins bridge ownership",
        "observed_model": "gpt-5.6-terra",
        "requested_model": "gpt-5.6-terra",
        "status": "matched"
      },
      {
        "lane": "owner-scoped v3 presets and carousel synchronization",
        "observed_model": "gpt-5.6-terra",
        "requested_model": "gpt-5.6-terra",
        "status": "matched"
      },
      {
        "lane": "governance, lessons, Allowed Files, and browser proof",
        "observed_model": "gpt-5.6-terra",
        "requested_model": "gpt-5.6-terra",
        "status": "matched"
      }
  ...
  "goal_memory_commit": "11e5e413b431bad4d3301e97cc1ebc68dcf6cf93",
  "goal_sha256": "sha256:360339dc080caca23c6271dc6ab898ada1147ffb1fbff2a1b9b100ba007ab403",
  "protected_surfaces": [
...
- **Evidence:** PR #53 shipped the host and bridge. All five residual owners
  ...
  and AutoNest visibility behavior.
...
- **Decision:** retain Option B, fix only runtime bridge ownership, allow the
  final real preset to delete into an empty carousel, and use
  `analysis.bounds` for Fill parity. Do not edit the prototype or protected
...
stacked docs PR after the published quiet PR lineage. Stop there. Do not create
a B3 implementation handoff, edit product files, open an implementation PR,
merge, deploy, change MODE, or touch Production in this session.
